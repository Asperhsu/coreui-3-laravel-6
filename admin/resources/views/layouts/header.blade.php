    ...
    <ul class="c-header-nav ml-auto mr-4">
        ...
        <li class="c-header-nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right pt-0">
                ...
                <a class="dropdown-item" href="#">
                    <svg class="c-icon mr-2">
                        <use xlink:href="{{ asset('admin/icons/sprites/free.svg#cil-task') }}"></use>
                    </svg> Tasks
                    <span class="badge badge-danger ml-auto">42</span>
                </a>
                <a class="dropdown-item" href="#">
                    <svg class="c-icon mr-2">
                        <use xlink:href="{{ asset('admin/icons/sprites/free.svg#cil-comment-square') }}"></use>
                ...
                <a class="dropdown-item" href="#">
                    <svg class="c-icon mr-2">
                        <use xlink:href="{{ asset('admin/icons/sprites/free.svg#cil-credit-card') }}"></use>
                    </svg> Payments
                    <span class="badge badge-secondary ml-auto">42</span>
                </a>
                <a class="dropdown-item" href="#">
                    <svg class="c-icon mr-2">
                        <use xlink:href="{{ asset('admin/icons/sprites/free.svg#cil-file') }}"></use>
